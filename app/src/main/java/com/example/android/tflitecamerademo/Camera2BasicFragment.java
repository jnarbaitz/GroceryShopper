...
public class Camera2BasicFragment extends Fragment
  ...
  public void onViewCreated(final View view, Bundle savedInstanceState) {
    ...
    button1View = (Button) view.findViewById(R.id.button1);
    ...
    button2View = (Button) view.findViewById(R.id.button2);
    button2View.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
        // Do something in response to button click
        showToast("Total amount paid: " + String.valueOf(classifier.payTotal()));
      }
    });
  }
